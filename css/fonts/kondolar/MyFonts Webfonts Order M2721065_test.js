...
woff = path + "/webfonts/woff/style_196622.woff";
if (http) {
...
//test for eot
eot = path + "/webfonts/eot/style_196622.eot";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
//test for svg
svg = path + "/webfonts/svg/style_196622.svg";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
//test for css
css = path + "/webfonts/datacss/MyFonts Webfonts Order M2721065.css";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
woff = path + "/webfonts/woff/style_196620.woff";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
if(xmlhttp.status == 200) {
	...
	addtoDiv('Woff_result','error',"WOFF File: " +woff+ " is inaccessable.  Check the file permissions and the MIME types");
//test for eot
eot = path + "/webfonts/eot/style_196620.eot";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
if(xmlhttp.status == 200) {
	...
	addtoDiv('eot_result','error',"EOT File: " +eot+" is inaccessable.  Check the file permissions and the MIME types");
//test for svg
svg = path + "/webfonts/svg/style_196620.svg";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
woff = path + "/webfonts/woff/style_196621.woff";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
if(xmlhttp.status == 200) {
	...
	addtoDiv('Woff_result','error',"WOFF File: " +woff+ " is inaccessable.  Check the file permissions and the MIME types");
//test for eot
eot = path + "/webfonts/eot/style_196621.eot";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
if(xmlhttp.status == 200) {
	...
	addtoDiv('eot_result','error',"EOT File: " +eot+" is inaccessable.  Check the file permissions and the MIME types");
//test for svg
svg = path + "/webfonts/svg/style_196621.svg";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
woff = path + "/webfonts/woff/style_196619.woff";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
if(xmlhttp.status == 200) {
	...
	addtoDiv('Woff_result','error',"WOFF File: " +woff+ " is inaccessable.  Check the file permissions and the MIME types");
//test for eot
eot = path + "/webfonts/eot/style_196619.eot";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
if(xmlhttp.status == 200) {
	...
	addtoDiv('eot_result','error',"EOT File: " +eot+" is inaccessable.  Check the file permissions and the MIME types");
//test for svg
svg = path + "/webfonts/svg/style_196619.svg";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
