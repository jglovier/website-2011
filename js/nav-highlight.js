/* Author:
		@jglovier - based almost entirely on script by @danheberden from w3fools.com used with permission (https://twitter.com/#!/danheberden/status/107484614171435008)
*/
(function($) {
    $(function() {
        ...
        // handle nav links
        $nav.delegate( 'a.scroll', 'click', function(e) {
